 ...
 * \param[in] swFtXDes reference positions (x, y, z, pitch, roll, yaw) [m] or [rad]
 * \param[out] h constraints vector
 * \param[out] jac jacobian matrix
 */
void SwFtXerrJac(double q[], double swFtXDes, bool side, double h[], double jac[], double swFtPos[])
{ 
    ...
    if (side == LEFT)
    {
        ...
        //
        h_1 = RL_0_115+RL_0_116+RL_0_117+RL_0_119-swFtXDes;
