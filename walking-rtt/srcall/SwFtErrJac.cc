 ...
 */
void SwFtErrJac(double q[], double swFtPosOrDes[], bool side, double h[], double jac[][6], double swFtPos[])
{ 
    ...
    if (side == LEFT)
    {
        ...
        C10 = cos(swFtPosOrDes[3]);
        S10 = sin(swFtPosOrDes[3]);
        C11 = cos(swFtPosOrDes[4]);
        S11 = sin(swFtPosOrDes[4]);
        C12 = cos(swFtPosOrDes[5]);
        S12 = sin(swFtPosOrDes[5]);
        ...
        swFtPos[2] = RL_0_315+RL_0_316+RL_0_317+RL_0_319;

        //
        h_1 = RL_0_115+RL_0_116+RL_0_117+RL_0_119-swFtPosOrDes[0];
        h_2 = RL_0_215+RL_0_216+RL_0_217+RL_0_219-swFtPosOrDes[1]+DPT_2_1+DPT_2_2;
        h_3 = RL_0_315+RL_0_316+RL_0_317+RL_0_319-swFtPosOrDes[2];
